...
export function GreenLineButton({text, on}) {
  return (
    <TouchableOpacity onPress={on} style={styles.GreenLineButton}>
...
export function WhiteButton({text, on}) {
  return (
    <TouchableOpacity onPress={on} style={styles.WhiteButton}>
...
export function LoginButton({text, on}) {
  return (
    <TouchableOpacity onPress={on} style={styles.LoginButton}>
      <Text style={styles.white}>{text}</Text>
    </TouchableOpacity>
  );
}
